...
Actualmente es muy común dentro de los desarrolladores usar [Markdown](https://es.wikipedia.org/wiki/Markdown), es usado en muchísimas plataformas que manejan texto plano (GitHub, foros, blogs, ...) lo que hace muy común inclusive el README.md.
...
algunas estadísticas tales como Total de Links, los que funcionales y además los rotos.
